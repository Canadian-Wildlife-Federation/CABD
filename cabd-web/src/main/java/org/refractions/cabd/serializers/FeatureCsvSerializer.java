...
/**
 * Serializes a single Feature to csv
 * 
 * @author Emily
 *
 */
@Component
public class FeatureCsvSerializer extends AbstractHttpMessageConverter<Feature>{

	@Autowired
	private FeatureListCsvSerializer listSerializer;
	
	public FeatureCsvSerializer() {
	...
	protected void writeInternal(Feature feature, HttpOutputMessage outputMessage)
		...
		FeatureList fl = new FeatureList(Collections.singletonList(feature), null, feature.getSrid());
