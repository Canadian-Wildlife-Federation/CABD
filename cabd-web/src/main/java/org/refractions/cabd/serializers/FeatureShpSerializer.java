...
/**
 * Serializes a single Feature to shapefile
 * 
 * @author Emily
 *
 */
@Component
public class FeatureShpSerializer extends AbstractHttpMessageConverter<Feature>{

	@Autowired
	private FeatureListShpSerializer listSerializer;
	
	public FeatureShpSerializer() {
