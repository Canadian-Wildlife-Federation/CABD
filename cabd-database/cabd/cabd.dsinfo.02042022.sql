...
AS SELECT d.cabd_id,
	...
	'features/datasources/' || d.cabd_id as datasource_url,
...
AS SELECT barriers.cabd_id,
	'features/datasources/' || barriers.cabd_id as datasource_url,
...
AS SELECT w.cabd_id,
	'features/datasources/' || w.cabd_id as datasource_url,
    'waterfalls'::text AS feature_type,
...
INSERT INTO cabd.feature_type_metadata(view_name, field_name, name, description,is_link, data_type, vw_simple_order, vw_all_order, include_vector_tile)
values('cabd.barriers_view', 'datasource_url', 'Feature Data Source Details', 'Link that identifiers the data source for the feature attributes', true, 'url', null, 16, false);

INSERT INTO cabd.feature_type_metadata(view_name, field_name, name, description,is_link, data_type, vw_simple_order, vw_all_order, include_vector_tile)
values('cabd.dams_view', 'datasource_url', 'Feature Data Source Details', 'Link that identifiers the data source for the feature attributes', true, 'url', null, 92, false);

INSERT INTO cabd.feature_type_metadata(view_name, field_name, name, description,is_link, data_type, vw_simple_order, vw_all_order, include_vector_tile)
values('cabd.fishways_view', 'datasource_url', 'Feature Data Source Details', 'Link that identifiers the data source for the feature attributes', true, 'url', null, 50, false);

INSERT INTO cabd.feature_type_metadata(view_name, field_name, name, description,is_link, data_type, vw_simple_order, vw_all_order, include_vector_tile)
values('cabd.waterfalls_view', 'datasource_url', 'Feature Data Source Details', 'Link that identifiers the data source for the feature attributes', true, 'url', null, 23, false);

INSERT INTO cabd.feature_type_metadata(view_name, field_name, name, description,is_link, data_type, vw_simple_order, vw_all_order, include_vector_tile)
values('cabd.add_features_view', 'datasource_url', 'Feature Data Source Details', 'Link that identifiers the data source for the feature attributes', true, 'url', null, 16, false);