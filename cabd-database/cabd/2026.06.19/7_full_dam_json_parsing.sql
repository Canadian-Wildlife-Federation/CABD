update cabd.community_attribute_mapping set attribute_value = 'difficult terrain' where attribute_name ='no_access_reason' and attribute_value = 'difficult yerrain';
