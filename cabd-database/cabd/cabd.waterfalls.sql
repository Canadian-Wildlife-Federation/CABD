...
INSERT INTO cabd.feature_type_metadata (view_name,field_name,"name",description,is_link, data_type, vw_simple_order,vw_all_order) VALUES
	 ('cabd.waterfalls_view','cabd_id','Barrier Identifier','Unique identifier for waterfall',false,'uuid',null,1),     	 
	 ('cabd.waterfalls_view','latitude','Latitude','Latitude of point location of the waterfall in decimal degrees; the point location is only an approximation of the actual waterfall location.',false,'double',1,2),
	 ('cabd.waterfalls_view','longitude','Longitude','Longitude of point location of the waterfall in decimal degrees; the point location is only an approximation of the actual waterfall location.',false,'double',2,3),
	 ('cabd.waterfalls_view','fall_name_en','Fall Name (English)','English given or known name of the waterfall.',false,'varchar(512)',3,4),
	 ('cabd.waterfalls_view','fall_name_fr','Fall Name (French)','French given or known name of the waterfall.',false,'varchar(512)',null,5),
	 ('cabd.waterfalls_view','waterbody_name_en','Waterbody Name (English)','English name of waterbody in which the waterfall is recorded.',false,'varchar(512)',4,6),
	 ('cabd.waterfalls_view','waterbody_name_fr','Waterbody Name (French)','French name of waterbody in which the waterfall is recorded.',false,'varchar(512)',null,7),
	 ('cabd.waterfalls_view','province_territory_code','Province/Territory Code',NULL,false,'varchar(2)',null,8),
	 ('cabd.waterfalls_view','province_territory','Province/Territory Name',NULL,false,'varchar(32)',5,9),
	 ('cabd.waterfalls_view','fall_height_m','Fall Height (m)','Height of the waterfall in meters.',false,'double',6,10),
	 ('cabd.waterfalls_view','data_source_id','Data Source Identifier',NULL,false,'varchar(256)',7,11),
	 ('cabd.waterfalls_view','data_source','Data Source',NULL,false,'varchar(256)',8,12),
	 ('cabd.waterfalls_view','capture_date','Capture Date','The capture date for a structure as documented in the original dataset, if provided.',false,'date',null,13),
	 ('cabd.waterfalls_view','complete_level_code','Completeness Level Code',NULL,false,'integer',null,14),
	 ('cabd.waterfalls_view','complete_level','Completeness Level Name','Level of information available for the barrier structure.',false,'varchar(32)',9,15),
	 ('cabd.waterfalls_view','last_update','Last Update Date','Most recent date of the data source used to create, revise or confirm the waterfall record.',false,'date',null,16),
	 ('cabd.waterfalls_view','comments','Comments','Unstructured comments about the waterfall.',false,'text',null,17),
