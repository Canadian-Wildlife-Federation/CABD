...
alter table cabd.attribute_set owner to cabd;
...
update cabd.feature_type_metadata set vw_mobile_order = 1 where field_name = 'cabd_id';
update cabd.feature_type_metadata set vw_mobile_order = 2 where field_name = 'passability_status';
update cabd.feature_type_metadata set vw_mobile_order = 3 where field_name = 'feature_type';
