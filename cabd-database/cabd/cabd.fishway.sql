...
('cabd.fishways_view','feature_type','Feature Type',NULL,false),
('cabd.fishways_view','cabd_id','System Identifier',NULL,false),
('cabd.fishways_view','latitude','Latitude',NULL,false),
('cabd.fishways_view','longitude','Longitude',NULL,false),
('cabd.fishways_view','dam_id','Dam Identifier',NULL,true),
('cabd.fishways_view','dam_name_en','Dam Name (English)',NULL,false),
('cabd.fishways_view','dam_name_fr','Dam Name (French)',NULL,false),
('cabd.fishways_view','river_name_en','River/Steam Name (English)',NULL,false),
('cabd.fishways_view','river_name_fr','River/Stream Name (French)',NULL,false),
('cabd.fishways_view','waterbody_name_en','Waterbody Name (English)',NULL,false),
('cabd.fishways_view','waterbody_name_fr','Waterbody Name (French)',NULL,false),
('cabd.fishways_view','watershed_group_code','Watershed Group Code',NULL,false),
('cabd.fishways_view','watershed_group_name','Watershed Group Name',NULL,false),
('cabd.fishways_view','nhn_workunit_id','NHN Working Unit ID',NULL,false),
('cabd.fishways_view','province_territory_code','Province/Territory Code',NULL,false),
('cabd.fishways_view','province_territory','Province/Territory Name',NULL,false),
('cabd.fishways_view','nearest_municipality','Nearest Municipality',NULL,false),
('cabd.fishways_view','fishpass_type_code','Fishway Type Code',NULL,false),
('cabd.fishways_view','fishpass_type','Fishway Type',NULL,false),
('cabd.fishways_view','monitoring_equipment','Monitoring Equipment',NULL,false),
('cabd.fishways_view','architect','Architect',NULL,false),
('cabd.fishways_view','contracted_by','Contracted By',NULL,false),
('cabd.fishways_view','constructed_by','Constructed By',NULL,false),
('cabd.fishways_view','plans_held_by','Plans Held By',NULL,false),
('cabd.fishways_view','purpose','Purpose of Fishway',NULL,false),
('cabd.fishways_view','designed_on_biology','Designed Based on Biology',NULL,false),
('cabd.fishways_view','length_m','Length (m)',NULL,false),
('cabd.fishways_view','elevation_m','Elevation (m)',NULL,false),
('cabd.fishways_view','inclination_pct','Inclination (%)',NULL,false),
('cabd.fishways_view','depth_m','Mean channel depth (m)',NULL,false),
('cabd.fishways_view','entrance_location_code','Entrance Location Code',NULL,false),
('cabd.fishways_view','entrance_location','Entrance Location',NULL,false),
('cabd.fishways_view','entrance_position_code','Entrance Position Code',NULL,false),
('cabd.fishways_view','entrance_position','Entrance Position',NULL,false),
('cabd.fishways_view','modified','Is Modified',NULL,false),
('cabd.fishways_view','modification_year','Modification Year',NULL,false),
...
('cabd.fishways_view','max_fishway_velocity_ms','Maximum Velocity of Water Flow(ms)',NULL,false),
('cabd.fishways_view','estimate_of_attraction_pct','Attraction Estimate (%)',NULL,false),
('cabd.fishways_view','estimate_of_passage_success_pct','Transit Success Estimate(%)',NULL,false),
('cabd.fishways_view','fishway_reference_id','Reference Identifier',NULL,false),
('cabd.fishways_view','data_source_id','Data Source Identifier',NULL,false),
('cabd.fishways_view','data_source','Data Source',NULL,false),
