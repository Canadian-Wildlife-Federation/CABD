...
CREATE TABLE dams.operating_status_codes (
	...
	"name" varchar(32) NULL, -- The status of the dam indicating continued active operation or the type of �end-of-life� action completed if operations have ceased; validity based on date from the �LAST_MODIFIED� field.
	description text NULL,
...
COMMENT ON COLUMN dams.operating_status_codes."name" IS 'The status of the dam indicating continued active operation or the type of �end-of-life� action completed if operations have ceased; validity based on date from the �LAST_MODIFIED� field.';
...
INSERT INTO cabd.feature_type_metadata (view_name,field_name,"name",description,is_link, data_type, vw_simple_order, vw_all_order) VALUES
	 ...
	 ('cabd.dams_medium_large_view','latitude','Latitude','Latitude of point location of dam in decimal degrees; the point location is only an approximation of the actual dam location.',false, 'double', 1, 2),
	 ('cabd.dams_medium_large_view','longitude','Longitude','Longitude of point location of dam in decimal degrees; the point location is only an approximation of the actual dam location.',false, 'double', 2, 3),
	 ('cabd.dams_medium_large_view','dam_name_en','Dam Name (English)','Given or known name of the dam structure, English.',false, 'varchar(512)', 3, 4),
	 ('cabd.dams_medium_large_view','dam_name_fr','Dam Name (French)','Given or known name of the dam structure, French.',false, 'varchar(512)', null, 5),
	 ('cabd.dams_medium_large_view','waterbody_name_en','Waterbody Name (English)','Name of waterbody in which the dam is recorded, English.',false, 'varchar(512)', 4, 6),
	 ('cabd.dams_medium_large_view','waterbody_name_fr','Waterbody Name (French)','Name of waterbody in which the dam is recorded, French.',false, 'varchar(512)', null, 7),
	 ('cabd.dams_medium_large_view','reservoir_name_en','Reservoir Name (English)','Name of the reservoir or controlled lake (i.e., impounded waterbody), English.',false, 'varchar(512)', null, 8),
	 ('cabd.dams_medium_large_view','reservoir_name_fr','Reservoir Name (French)','Name of the reservoir or controlled lake (i.e., impounded waterbody), French.',false, 'varchar(512)', null, 9),
	 ('cabd.dams_medium_large_view','province_territory_code','Province/Territory Code',NULL,false, 'varchar(2)', null, 10),
	 ('cabd.dams_medium_large_view','province_territory','Province/Territory Name',NULL,false, 'varchar(32)', 5, 11),
	 ('cabd.dams_medium_large_view','passability_status_code','Passability Status Code','Code referencing the degree to which the structure acts as a barrier to fish in the upstream direction.',false, 'integer', null, 12),
	 ('cabd.dams_medium_large_view','passability_status','Passability Status','The degress to which the structure acts as a barrier to fish in the upstream direction.',false, 'varchar(32)', 6, 13),
	 ('cabd.dams_medium_large_view','passability_status_note','Passability Status Node','Unstructured notes to provide context for the assigned passability status code (e.g., species restrictions)',false, 'text', null, 14),
	 ('cabd.dams_medium_large_view','up_passage_type_code','Upstream Passage Type Code',NULL,false, 'integer', null, 15),
	 ('cabd.dams_medium_large_view','up_passage_type','Upstream Passage Type',NULL,false, 'varchar(32)', 7, 16),
	 ('cabd.dams_medium_large_view','down_passage_route_code','Downstream Passage Route Code',NULL,false, 'integer', null, 17),
	 ('cabd.dams_medium_large_view','down_passage_route','Downstream Passage Route',NULL,false, 'varchar(32)', 8, 18),
	 ('cabd.dams_medium_large_view','operating_status_code','Operating Status Code',NULL,false, 'integer', null, 19),
	 ('cabd.dams_medium_large_view','operating_status','Operating Status',NULL,false, 'varchar(32)', 9, 20),
	 ('cabd.dams_medium_large_view','operating_note','Operating Note','Unstructured comments on important operation considerations for the dam structure.',false, 'text', null, 21),
	 ('cabd.dams_medium_large_view','use_code','Dam Use Code',NULL,false, 'integer', null, 22),
	 ('cabd.dams_medium_large_view','dam_use','Dam Use',NULL,false, 'varchar(32)', 10, 23),
	 ('cabd.dams_medium_large_view','function_code','Dam Function Code',NULL,false, 'integer', 11, 24),
	 ('cabd.dams_medium_large_view','function_name','Dam Function',NULL,false, 'varchar(64)', 12, 24),
	 ('cabd.dams_medium_large_view','construction_type_code','Construction Type Code',NULL,false, 'integer', null, 25),
	 ('cabd.dams_medium_large_view','construction_type','Construction Type',NULL,false, 'varchar(32)', 13, 26),
	 ('cabd.dams_medium_large_view','construction_year','Construction Year','Year in which the dam was built (not further specified: year of construction; year of completion; year of commissioning; year of refurbishment/update; etc.)',false, 'integer', 14, 27),
	 ('cabd.dams_medium_large_view','size_class_code','Dam Size Class Code','The size classification of the dam based on the height of the dam in meters (dam_hgt_m).',false, 'integer', null, 28),
	 ('cabd.dams_medium_large_view','size_class','Dam Size',NULL,false, 'varchar(32)', 15, 29),
	 ('cabd.dams_medium_large_view','height_m','Height (m)','Reported height of the dam in meters. Depending on the data source this could variably be height of dam wall, crest height, or head height.',false, 'double', 16, 30),
	 ('cabd.dams_medium_large_view','length_m','Length (m)','Length of the crest of the dam from one bank (or abutment) to the other in meters.',false, 'double', 17, 31),
	 ('cabd.dams_medium_large_view','data_source_id','Data Source Id','The unique id assigned to the dam record in the original data source.',false, 'varchar(256)', 18, 32),
	 ('cabd.dams_medium_large_view','data_source','Data Source','The original data source from which the dam record was obtained.',false, 'varchar(256)', 19, 33),
	 ('cabd.dams_medium_large_view','complete_level_code','Complete Level Code',NULL,false, 'integer', null, 34),
	 ('cabd.dams_medium_large_view','complete_level','Complete Level',NULL,false, 'varchar(32)', 20, 35),
	 ('cabd.dams_medium_large_view','owner','Owner','Person, company, organization, government unit, public utility, corporation or other entity which either holds a water license to operate a dam or retains the legal property title on the dam site.',false, 'varchar(512)', null, 36),
	 ('cabd.dams_medium_large_view','ownership_type_code','Ownership Type Code',NULL,false, 'integer', null, 37),
	 ('cabd.dams_medium_large_view','ownership_type','Ownership Type',NULL,false, 'varchar(32)', null, 38),
	 ('cabd.dams_medium_large_view','province_compliance_status','Provincial Compliance Status','The status of regulatory compliance with provincial licensing body.',false, 'varchar(64)', null, 39),
	 ('cabd.dams_medium_large_view','federal_compliance_status','Federal Compliance Status','The status of regulatory compliance with the federal licensing body.',false, 'varchar(64)', null, 40),
	 ('cabd.dams_medium_large_view','use_irrigation_code','Use Irrigation Code','Indicates the dam is used for irrigation purposes, and the extent to which irrigation is a planned use (i.e., main use, major use, or secondary use).',false, 'integer', null, 41),
	 ('cabd.dams_medium_large_view','use_irrigation','Use Irrigation',NULL,false, 'varchar(32)', null, 42),
	 ('cabd.dams_medium_large_view','use_electricity_code','Use Hydroelectricity Code','Indicates the dam is used for hydroelectric energy production, and the extent to which hydroelectric production is a planned use (i.e., main use, major use, or secondary use).',false, 'integer', null, 43),
	 ('cabd.dams_medium_large_view','use_electricity','Use Hydroelectricity',NULL,false, 'varchar(32)', null, 44),
	 ('cabd.dams_medium_large_view','use_supply_code','Use Water Supply Code','Indicates the dam is used for water supply purposes, and the extent to which water supply is a planned use (i.e., main use, major use, or secondary use).',false, 'integer', null, 45),
	 ('cabd.dams_medium_large_view','use_supply','Use Water Supply',NULL,false, 'varchar(32)', null, 46),
	 ('cabd.dams_medium_large_view','use_floodcontrol_code','Use Flood Control Code','Indicates the dam is used for flood control purposes, and the extent to which flood control is a planned use (i.e., main use, major use, or secondary use).',false, 'integer', null, 47),
	 ('cabd.dams_medium_large_view','use_floodcontrol','Use Flood Control',NULL,false, 'varchar(32)', null, 48),
	 ('cabd.dams_medium_large_view','use_recreation_code','Use Recreation Code','Indicates the dam is used for recreation purposes, and the extent to which recreation is a planned use (i.e., main use, major use, or secondary use).',false, 'integer', null, 49),
	 ('cabd.dams_medium_large_view','use_recreation','Use Recreation',NULL,false, 'varchar(32)', null, 50),
	 ('cabd.dams_medium_large_view','use_navigation_code','Use Navigation Code','Indicates the dam is used for navigation, and the extent to which navigation is a planned use (i.e., main use, major use, or secondary use).',false, 'integer', null, 51),
	 ('cabd.dams_medium_large_view','use_navigation','Use Navigation',NULL,false, 'varchar(32)', null, 52),
	 ('cabd.dams_medium_large_view','use_fish_code','Use Fisheries Code','Indicates the dam is used for fisheries purposes, and the extent to which fisheries are a planned use (i.e., main use, major use, or secondary use).',false, 'integer', null, 53),
	 ('cabd.dams_medium_large_view','use_fish','Use Fisheries',NULL,false, 'varchar(32)', null, 54),
	 ('cabd.dams_medium_large_view','use_pollution_code','Use Pollution Control Code','Indicates the dam is used for pollution control purposes, and the extent to which pollution control is a planned use (i.e., main use, major use, or secondary use).',false, 'integer', null, 55),
	 ('cabd.dams_medium_large_view','use_pollution','Use Pollution Control',NULL,false, 'varchar(32)', null, 56),
	 ('cabd.dams_medium_large_view','use_invasivespecies_code','Use Invasive Species Control Code','Indicates the dam is used in control invasive species and the extent to which invasive species control is a planned use (i.e., Main use, major use, or secondary use).',false, 'integer', null, 57),
	 ('cabd.dams_medium_large_view','use_invasivespecies','Use Invasive Species Control',NULL,false, 'varchar(32)', null, 58),
	 ('cabd.dams_medium_large_view','use_other_code','Use Other Code','Indicates the dam is used for "other" purposes, and the extent to which it is a planned use (i.e., Main use, major use, or secondary use).',false, 'integer', null, 59),
	 ('cabd.dams_medium_large_view','use_other','Use Other',NULL,false, 'varchar(32)', null, 60),
	 ('cabd.dams_medium_large_view','lake_control_code','Lake Control Code','Indicates whether a reservoir has been built at the location of an existing natural lake using a lake control structure; currently this column only contains limited entries; "Yes" = lake control structure raises original lake level; "Enlarged" = lake control structure enlarged the original lake surface area; "Maybe" = not sure, but data seems to indicate a lake control structure.',false, 'integer', null, 61),
	 ('cabd.dams_medium_large_view','lake_control','Lake Control',NULL,false, 'varchar(32)', null, 62),
	 ('cabd.dams_medium_large_view','assess_schedule','Assessment Schedule','Frequency at which the dam structure is assessed by ownership party or regulatory body.',false, 'varchar(100)', null, 63),
	 ('cabd.dams_medium_large_view','expected_life','Expected Life (years)','Number of years the dam structure is expected to last.',false, 'integer', null, 64),
	 ('cabd.dams_medium_large_view','maintenance_last','Last Maintenance Date','Date of last maintenance or renovation work performed on the barrier.',false, 'date', null, 65),
	 ('cabd.dams_medium_large_view','maintenance_next','Next Maintenance Date','Date of the next scheduled maintenance or renovation work performed on the barrier.',false, 'date', null, 66),
	 ('cabd.dams_medium_large_view','condition_code','Dam Function',NULL,false, 'integer', null, 67),
	 ('cabd.dams_medium_large_view','dam_condition','Dam Condition',NULL,false, 'varchar(32)', null, 68),
	 ('cabd.dams_medium_large_view','spillway_capacity','Spillway Capacity','The designed capacity of the spillway in m3 per second.',false, 'double', null, 69),
	 ('cabd.dams_medium_large_view','spillway_type_code','Spillway Type Code',NULL,false, 'integer', null, 70),
	 ('cabd.dams_medium_large_view','spillway_type','Spillway Type',NULL,false, 'varchar(32)', null, 71),
	 ('cabd.dams_medium_large_view','reservoir_present','Reservoir Present','Indicates if a reservoir is present due to the creation of the dam.',false, 'boolean', null, 72),
	 ('cabd.dams_medium_large_view','reservoir_area_skm','Reservoir Area (sqm)','Representative surface area of reservoir in square kilometers.',false, 'double', null, 73),
	 ('cabd.dams_medium_large_view','reservoir_depth_m','Reservoir Depth (m)','Average depth of reservoir in meters.',false, 'double', null, 74),
	 ('cabd.dams_medium_large_view','storage_capacity_mcm','Storage Capacity (cm)','Storage capacity of reservoir in million cubic meters.',false, 'double', null, 75),
	 ('cabd.dams_medium_large_view','avg_rate_of_discharge_ls','Average Rate Of Discharge (l/s)','Average rate of discharge at dam location in liters per second.',false, 'double', null, 76),
	 ('cabd.dams_medium_large_view','degree_of_regulation_pc','Degree of Regulation','Degree of Regulation (DOR) in percent; equivalent to "residence time" of water in the reservoir; calculated as ratio between storage capacity (Cap_mcm) and total annual flow (derived from Dis_avg_ls); values capped at 10,000 indicate exceedingly high values, which may be due to inconsistencies in the data and/or incorrect allocation to the river network and the associated discharges.',false, 'double', null, 77),
	 ('cabd.dams_medium_large_view','provincial_flow_req','Provinical Flow Requirements (cm)','Legislated flow requirements for the dam structure in cubic meters per second regulated by the provincial licensing body.',false, 'double', null, 77),
	 ('cabd.dams_medium_large_view','federal_flow_req','Federal Flow Requirements (cm)','Minimum flow recommendations for the dam structure in cubic meters per second. Based on assessments by Fisheries and Oceans Canada for the protection of fish and fish habitat.',false, 'double', null, 78),
	 ('cabd.dams_medium_large_view','catchment_area_skm','Upstream Catchment Area (sqkm)','Area of upstream catchment draining into the reservoir in square kilometers. The area of upstream catchment is defined by "Elementary Catchment" units in the National Hydrography Network.',false, 'double', null, 79),
	 ('cabd.dams_medium_large_view','hydro_peaking_system','Has Hydro Peaking System','Indicates if the dam employs a hydro peaking system.',false, 'boolean', null, 80),
	 ('cabd.dams_medium_large_view','generating_capacity_mwh','Generating Capacity (mwh)','The amount of electricity the hydroelectric facility can produce in megawatt hours.',false, 'double', null, 81),
	 ('cabd.dams_medium_large_view','turbine_number','Number of Turbines','The number of turbines in the dam structure.',false, 'integer', null, 82),
	 ...
	 ('cabd.dams_medium_large_view','feature_type','Feature Type',NULL,false, 'text', null, 93),
	 ('cabd.dams_medium_large_view','geometry','Location',NULL,false, 'geometry', null, null);