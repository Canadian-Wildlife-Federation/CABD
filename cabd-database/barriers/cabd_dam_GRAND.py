...
update {workingTable} set 
    ...
    removed_year = CASE WHEN REM_YEAR = -99 THEN NULL ELSE REM_YEAR END,
    height_m = case when DAM_HGT_M = -99 THEN NULL ELSE DAM_HGT_M END, 
    length_m = CASE WHEN DAM_LEN_M = -99 THEN NULL ELSE DAM_LEN_M END;
