...
tempTableRaw = "dams_nswf_original"
tempTable = tempSchema + "." + tempTableRaw
workingSchema = "load"
workingTableRaw = "dams_nswf"
...
if dataFile == '':
    print("Data file required.  Usage: LOAD_dams_nswf.py <datafile>")
    sys.exit()
...
UPDATE {tempTable} SET waterbody_name_en = rivname_1;
UPDATE {tempTable} SET data_source = 'nswf_' || shape_fid;
