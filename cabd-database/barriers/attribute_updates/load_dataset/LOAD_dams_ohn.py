...
tempTableRaw = "dams_ohn_original"
...
if dataFile == '':
    print("Data file required.  Usage: LOAD_dams_ohn.py <datafile>")
    sys.exit()
...
UPDATE {tempTable} SET data_source = 'ohn_' || ogf_id;
