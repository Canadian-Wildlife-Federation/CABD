...
script = main.MappingScript("jensen_bathymetry")

mappingquery = f"""

--create new data source record
INSERT INTO cabd.data_source (id, name, version_date, version_number, source, comments)
VALUES('{script.dsUuid}', 'Jensen (Pothole) Reservoir Bathymetry', now(), null, 'Alberta Environment and Parks', 'Data update - ' || now());
