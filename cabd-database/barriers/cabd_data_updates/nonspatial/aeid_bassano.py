...
script = main.MappingScript("eid_bassano")

mappingquery = f"""

--create new data source record
INSERT INTO cabd.data_source (id, name, version_date, version_number, source, comments)
VALUES('{script.dsUuid}', 'Eastern Irrigation District - Bassano Dam Factsheet', now(), null, 'Eastern Irrigation District', 'Data update - ' || now());
