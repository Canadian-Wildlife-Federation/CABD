...
script = main.MappingScript("little_bow_fin_2020")

mappingquery = f"""

--create new data source record
INSERT INTO cabd.data_source (id, name, version_date, version_number, source, comments)
VALUES('{script.dsUuid}', 'Little Bow Reservoir FIN Summary 2020', now(), null, 'Alberta Environment and Parks', 'Data update - ' || now());
