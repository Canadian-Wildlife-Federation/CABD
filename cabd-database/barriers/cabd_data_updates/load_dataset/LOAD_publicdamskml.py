...
UPDATE {script.tempTable} SET ownership_type_code =
    ...
    WHEN
        ...
        OR (regexp_match("owner", '(?i)(Invest)|(Ener)|(Esta)|(Projec)|(Homes)|(Mines)|(Utilit)|(Canadian Nat)|(Pacific)') IS NOT NULL)
        ...
        OR ("owner" ILIKE '%Forest' AND "owner" NOT ILIKE '%District%' AND "owner" NOT ILIKE 'Ministry%')
        OR "owner" IN(
