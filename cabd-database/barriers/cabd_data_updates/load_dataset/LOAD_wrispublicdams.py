...
UPDATE {script.tempTable} SET ownership_type_code =
    ...
    WHEN
        ...
        THEN 3
    WHEN
        (regexp_match("owner", '(?i)(Cattle)|(Coal)|(Pulp)|(Resort)|(Enter)|(Develop)|(Farms)|(Golf)|(Holdings)|(Corpor)|(Corp)\.?|(Ltd)|(\bLimited\b)') IS NOT NULL)
        OR (regexp_match("owner", '(Inc)\.*?$|(Invest)|(Energy)|(Estate)|(Properties)|(Projec)|(Homes)|(Mines)|(Utilit)|(Canadian Nat)|(Pacific)|(\bRanch\b)|(Ranches)|(\bMine\b)') IS NOT NULL)
