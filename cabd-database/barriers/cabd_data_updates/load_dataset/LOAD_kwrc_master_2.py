...
UPDATE {script.nonTidalStructures} SET 
    "substrate composition (outlet) bedrock (%)" = 0,
    "substrate composition (outlet) boulder (%)" = 100
    WHERE "substrate composition (outlet) bedrock (%)" = 'rip rap';
