...
SET    
    ...
    river_name_fr_ds = CASE WHEN (cabd.river_name_fr IS NULL AND {script.datasetname}.river_name_fr IS NOT NULL) THEN {script.datasetname}.data_source ELSE cabdsource.river_name_fr_ds END,   
...
SET
    ...
    river_name_fr = CASE WHEN (cabd.river_name_fr IS NULL AND {script.datasetname}.river_name_fr IS NOT NULL) THEN {script.datasetname}.river_name_fr ELSE cabd.river_name_fr END,
