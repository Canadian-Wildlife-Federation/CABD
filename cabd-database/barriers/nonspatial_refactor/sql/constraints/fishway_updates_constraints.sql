...
ALTER TABLE cabd.fishway_updates
  DROP CONSTRAINT IF EXISTS fishway_updates_entry_classification_check;

ALTER TABLE cabd.fishway_updates
  ADD CONSTRAINT fishway_updates_entry_classification_check
...
ALTER TABLE cabd.fishway_updates
  DROP CONSTRAINT IF EXISTS fish_record_unique;

ALTER TABLE cabd.fishway_updates
  ADD CONSTRAINT fishway_updates_unique_cabd_source
...
ALTER TABLE cabd.fishway_updates rename column update_status to status;