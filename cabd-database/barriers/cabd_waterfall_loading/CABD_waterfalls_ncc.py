...
workingSchema = "load"
workingTableRaw = "waterfalls_ncc"
...
if dataFile == '':
    print("Data file required.  Usage: cabd_waterfall_ncc.py <datafile>")
    sys.exit()
...
update {workingTable} set fall_name_en = Barrier_Na;
--update {workingTable} set fall_name_fr;
update {workingTable} set waterbody_name_en = WATERBODY;
...
update {workingTable} set province_territory_code = 
    CASE 
    WHEN PROV = 'AB' THEN 'ab'
    WHEN PROV = 'BC' THEN 'bc'
    WHEN PROV = 'MB' THEN 'mb'
    WHEN PROV = 'NB' THEN 'nb'
    WHEN PROV = 'NL' THEN 'nl'
    WHEN PROV = 'NS' THEN 'ns'
    WHEN PROV = 'NT' THEN 'nt'
    WHEN PROV = 'NU' THEN 'nu'
    WHEN PROV = 'ON' THEN 'on'
    WHEN PROV = 'PE' THEN 'pe'
    WHEN PROV = 'SK' THEN 'sk'
    WHEN PROV = 'YT' THEN 'yt'
    WHEN PROV = 'QC' THEN 'qc'
    ELSE NULL END;
...
update {workingTable} set "comments" = Comment;
