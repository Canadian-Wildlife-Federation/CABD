...
workingSchema = "load"
workingTableRaw = "waterfalls_canvec"
...
if dataFile == '':
    print("Data file required.  Usage: cabd_waterfall_canvec.py <datafile>")
    sys.exit()
...
update {workingTable} set fall_name_en = name1_en;
update {workingTable} set fall_name_fr = name1_fr;
...
update {workingTable} set data_source_id = feature_id;
update {workingTable} set data_source = 'canvec';
