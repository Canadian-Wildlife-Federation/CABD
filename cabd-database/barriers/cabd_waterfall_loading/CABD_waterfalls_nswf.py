...
workingSchema = "load"
workingTableRaw = "waterfalls_nswf"
...
if dataFile == '':
    print("Data file required.  Usage: cabd_waterfall_nswf.py <datafile>")
    sys.exit()
...
update {workingTable} set waterbody_name_en = RIVNAME_1;
...
update {workingTable} set data_source_id = SHAPE_FID;
update {workingTable} set data_source = 'nswf';
