...
workingSchema = "load"
workingTableRaw = "waterfalls_nbwf"
...
if dataFile == '':
    print("Data file required.  Usage: cabd_waterfall_nbwf.py <datafile>")
    sys.exit()
...
update {workingTable} set nearest_municipality = City;
...
update {workingTable} set data_source_id = NB_ID;
update {workingTable} set data_source = 'nbwf';
