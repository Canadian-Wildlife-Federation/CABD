...
workingSchema = "load"
workingTableRaw = "waterfalls_fiss"
...
if dataFile == '':
    print("Data file required.  Usage: cabd_waterfall_fiss.py <datafile>")
    sys.exit()
...
update {workingTable} set waterbody_name_en = GAZETTED_NAME;
...
update {workingTable} set fall_height_m = HEIGHT;
--update {workingTable} set capture_date;
--update {workingTable} set last_update;
--update {workingTable} set "comments";
update {workingTable} set data_source_id = FISH_OBSTACLE_POINT_ID;
update {workingTable} set data_source = 'FISS_Obstacles';
