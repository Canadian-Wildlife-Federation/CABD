...
if dataFile == '':
    print("Data file required.  Usage: cabd_dams_nlprov.py <datafile>")
    sys.exit()
...
update {workingTable} set owner = OWNER_NAME;
...
update {workingTable} set operating_status_code = 
    CASE
    WHEN DAMSTATUS = 'Abandoned' THEN 1
    WHEN DAMSTATUS = 'Active' THEN 2
    WHEN DAMSTATUS =  'Decommissioned' THEN 3
    ELSE NULL END;
update {workingTable} set use_code = 
    ...
    WHEN PURPOSE_INDUSTRIAL = 'Secondary' THEN 10
    WHEN PURPOSE_HYDRO = 'Primary' THEN 2
    WHEN PURPOSE_HYDRO = 'Secondary' THEN 2
    WHEN PURPOSE_FLOOD = 'Primary' THEN 4
    WHEN PURPOSE_FLOOD = 'Secondary' THEN 4
    WHEN PURPOSE_ICE = 'Primary' THEN 10
    WHEN PURPOSE_ICE = 'Secondary' THEN 10
    WHEN PURPOSE_FORESTRY = 'Primary' THEN 10
    WHEN PURPOSE_FORESTRY = 'Secondary' THEN 10
    WHEN PURPOSE_UNKNOWN = 'Primary' THEN 10
    WHEN PURPOSE_UNKNOWN = 'Secondary' THEN 10
    WHEN PURPOSE_OTHER = 'Primary' THEN 10
    WHEN PURPOSE_OTHER = 'Secondary' THEN 10
    ELSE NULL END;
...
update {workingTable} set construction_year = cast(YEARBUILT as numeric);
...
update {workingTable} set data_source = 'nlprov';
