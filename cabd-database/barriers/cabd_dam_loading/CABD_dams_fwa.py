...
if dataFile == '':
    print("Data file required.  Usage: cabd_dams_fwa.py <datafile>")
    sys.exit()
...
alter table {workingTable} rename watershed_group_code to watershed_group_code_orig;
...
update {workingTable} set data_source = 'FWA_Obstructions';
