...
if dataFile == '':
    print("Data file required.  Usage: cabd_dams_ab_basefeatures.py <datafile>")
    sys.exit()
...
update {workingTable} set dam_name_en = NAME;
...
update {workingTable} set data_source_id = BF_ID;
update {workingTable} set data_source = 'ab_basefeatures';
...
reservoir_name_en,reservoir_name_fr,watershed_group_code,nhn_workunit_id,
