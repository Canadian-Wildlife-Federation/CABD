...
UPDATE {schema}.modelled_crossings SET transport_feature_id = 
    CASE
    WHEN transport_feature_source = '{roadsTable[0]}' THEN osm_id_roads::varchar
    WHEN transport_feature_source = '{railTable[0]}' THEN osm_id_rn::varchar
    WHEN transport_feature_source = '{resourceRoadsTable[0]}' THEN osm_id_resource_road::varchar
    WHEN transport_feature_source = '{trailTable[0]}' THEN osm_id_trails::varchar
    ELSE NULL END;
"""
executeQuery(conn, sql)
