...
pycmd = '"' + ogr + '" -f "PostgreSQL" PG:"' + orgDb + '" -nln "' + schema + '.me_osm_roads" -lco GEOMETRY_NAME=geometry -nlt MULTILINESTRING "' + srcFile + '" "me_osm_roads" -t_srs EPSG:' + cabdSRID + ' -overwrite"'
log(pycmd)
subprocess.run(pycmd)

pycmd = '"' + ogr + '" -f "PostgreSQL" PG:"' + orgDb + '" -nln "' + schema + '.me_osm_rn" -lco GEOMETRY_NAME=geometry -nlt MULTILINESTRING "' + srcFile + '" "me_osm_rn" -t_srs EPSG:' + cabdSRID + ' -overwrite"'
log(pycmd)
subprocess.run(pycmd)
