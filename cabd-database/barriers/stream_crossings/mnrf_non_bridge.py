...
def mapAttributes(conn):
    ...
    UPDATE {schema}.modelled_crossings SET passability_status =
        CASE
        WHEN (a.FLOW_BLOCKAGE_FLG != 'Clear' OR a.BEAVER_BLOCKAGE_IND is true OR a.SEDIMENT_BLOCKAGE_IND is true OR a.WOODY_DEBRIS_BLOCKAGE_IND is true) THEN 'barrier'
        WHEN (a.FLOW_BLOCKAGE_FLG = 'Clear' AND a.BEAVER_BLOCKAGE_IND is false AND a.SEDIMENT_BLOCKAGE_IND is false AND a.WOODY_DEBRIS_BLOCKAGE_IND is false) THEN 'passable'
        ELSE NULL END
