...
# Northwest Territories specific additional datasets
...
print("Removing crossings on winter roads...")
...
UPDATE {schema}.modelled_crossings SET reviewer_status = 'removed', crossing_subtype = 'no crossing', crossing_subtype_source = 'Automatically removed crossing on winter road based on match from {roadsTable[0]}'
    WHERE "closing" = 'Summer' OR "roadclass" = 'Winter';
"""
