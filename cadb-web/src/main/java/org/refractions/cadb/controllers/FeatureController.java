...
import org.refractions.cadb.CadbConfigurationProperties;
import org.refractions.cadb.dao.FeatureDao;
import org.refractions.cadb.dao.FeatureTypeManager;
import org.refractions.cadb.exceptions.ApiError;
import org.refractions.cadb.exceptions.NotFoundException;
import org.refractions.cadb.model.Feature;
import org.refractions.cadb.model.FeatureList;
...
public class FeatureController {
	...
	@Autowired
	CadbConfigurationProperties properties;
	...
	public ResponseEntity<List<FeatureType>> getFeatureTypes(HttpServletRequest request) {
		...
		//configure urls
		UriComponents rooturl = ServletUriComponentsBuilder.fromContextPath(request)
		        .path("/" + PATH).build();
		types.forEach(e->e.setUrl(rooturl.toUriString()));
