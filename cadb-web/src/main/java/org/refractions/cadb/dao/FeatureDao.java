...
import org.refractions.cadb.exceptions.InvalidDatabaseConfigException;
...
public class FeatureDao {
	 ...
	 */
	public static final String ID_FIELD = "cadb_id";
	...
	public Feature getFeature(UUID uuid) {
		String type = null;
		try {
			String query = "SELECT feature_type FROM " + FeatureViewMetadata.ALL_FEATURES_VIEW + " WHERE cadb_id = ? ";
